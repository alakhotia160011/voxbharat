        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          {calls.length > 0 && (
            <button
              ...
              className="px-4 py-2 text-sm font-body font-medium bg-indigo text-white rounded-lg hover:bg-indigo/90 transition-colors cursor-pointer flex items-center gap-2"
            >
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-body font-medium bg-saffron text-white rounded-lg hover:bg-saffron/90 transition-colors cursor-pointer disabled:opacity-50 flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {calls.length > 0 && (
            <div className="flex gap-2 flex-shrink-0 ml-4">
              ...
              <button
                onClick={() => generateProjectPDF(projectName, analytics, breakdowns, calls)}
                className="px-3 py-1.5 text-sm font-body bg-indigo text-white rounded-lg hover:bg-indigo/90 transition-colors cursor-pointer"
              >
                Export PDF
              </button>
            </div>
